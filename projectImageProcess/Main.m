...
ndvi_t = orto.getNDVIThreshold(ndvi, graythresh(ndvi));
...
ndwi_t = orto.getNDWIThreshold(ndwi, graythresh(ndwi));
% p1.showData(ndwi_t, 'Ortofoto', 'NDWI with threshold');
ortoRed = imOrto(:,:,2);
resultOrto = orto.getResultOrto(ortoRed, ndvi_t, ndwi_t);
% p1.showData(resultOrto, 'Ortofoto', 'Result of ortofoto');

% Image classification
% Training sites and classes
